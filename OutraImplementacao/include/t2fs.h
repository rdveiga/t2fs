...
/**** MODIFICAÇOES ADICIONAIS ****/
/** TEM OUTRAS NA FIM DO ARQUIVO */
#define INVALID_PTR 0xFFFFFFFF

/* Total size: 8 Bytes
 * -> 32 file descriptors on a sector
 */
struct file_descriptor {
    /* address of the record descriving the current opened file */
    DWORD record_address; //4 bytes
    DWORD current_pointer; //4 bytes
};
...
struct t2fs_superbloco {
    ...
    /* Não usados */
    char    Reserved[44];  // : 108 bytes - 64 (FileDescReg)

    /* Registro que descreve o aquivo que mantém o array de file descriptors */
    struct t2fs_record FileDescrReg;
 ...
 * Returns -2 if repertory is full
 */
...
/********** MODIFICAÇOES ADICIONAIS **********/
//typedef struct t2fs_record struct_record;
//typedef struct t2fs_superbloco struct_superbloco;
/*********************************************/
